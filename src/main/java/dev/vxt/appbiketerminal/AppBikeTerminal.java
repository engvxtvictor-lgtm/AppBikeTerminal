...
public class AppBikeTerminal {
    ...
    public static void main(String[] args) {
        ...
        boolean usuarioElegivel = true;

        double valorCorrida = tempoUso * tarifaPorMinuto;
        double valorFinal = valorCorrida;

        if (usuarioElegivel) {

            double valorDesconto = valorCorrida * 0.10;
            valorFinal = valorCorrida - valorDesconto;
        ...
        System.out.println("Estimativa de tempo de uso: " + tempoUso + " minutos");
        System.out.printf("Valor total da corrida: R$ %.2f%n", valorFinal);

        System.out.println("========================================");
        System.out.println("Tmj, espero que tenha gostado!");
        System.out.println("Valeu por usar o AppBike!");
